...
💻 Developer: 𝐈𝐌 𝐂𝐎𝐎𝐋 𝐁𝐎𝐎𝐘 𝓢𝓱𝓪𝓭𝓸𝔀 𝓚𝓲𝓷𝓰 <br>

🔰 𝑬𝑻𝑯𝑰𝑪𝑨𝑳 𝑪𝒀𝑩𝑬𝑹𝑺𝑬𝑪𝑼𝑹𝑰𝑻𝒀 𝑨𝑾𝑨𝑹𝑬𝑵𝑬𝑺𝑺 𝑪𝑯𝑨𝑵𝑵𝑬𝑳 ™ 🇱🇰 <br>

📌️ Telegram Chanel: https://t.me/COOLBOOY552 <br>
...
```
```
* git clone https://github.com/imcoolbooy/MEDIA-DOWNLOADER-v3.0.git
```
```
* cd MEDIA-DOWNLOADER-v3.0
```
```
* chmod +x *
```
